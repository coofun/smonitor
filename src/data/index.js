...
export function getBatteryData() {
  let url = '/cwld/smartBatteryAction/getBatteryDataByParams.action'
...
export function getBatteryTrackByParams(deviceId, startTime, endTime) {
  let url = '/cwld/smartBatteryAction/getBatteryTrackByParams.action?deviceId=' + deviceId + '&startTime=' + startTime + '&endTime=' + endTime
  return request(url, 'post', null, null)
}

export function getBatteryStatusByParams(city) {
  let url = '/cwld/smartBatteryAction/getBatteryStatusByParams.action' + (city ? '?city=' + city : '')
  return request(url, 'post', null, null)
}

export function getBatteryAlarmNumByParams(city, startTime, endTime) {
  let url = '/cwld/smartBatteryAction/getBatteryAlarmNumByParams.action'

  if (city) {
    url += '?city=' + city + '&startTime=' + startTime + '&endTime=' + endTime
  } else {
...
export function getChargingPileByCity(city, condition) {
  let url = '/cwld/mainDisplayAction/getChargingPileByCity.action'
...
export function getChargingPileStatusByCity(city) {
  let url = '/cwld/mainDisplayAction/getChargingPileStatusByCity.action'
...
export function getChargingOrderNumByParams(city, startTime, endTime) {
  let url = '/cwld/mainDisplayAction/getChargingOrderNumByParams.action'
...
export function getStoreNumByParams(city) {
  let url = '/cwld/mainDisplayAction/getStoreNumByParams.action'
...
export function getStoreCategoryByCity(city) {
  let url = '/cwld/mainDisplayAction/getStoreCategoryByCity.action'
...
export function getStoreOrderNumByParams(city, startTime, endTime) {
  let url = '/cwld/mainDisplayAction/getStoreOrderNumByParams.action'
